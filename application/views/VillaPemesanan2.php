...
<html lang="en">
   ...
   <body class="main-layout">
      ...
      <!-- our_room -->
      <?php
      if (null !==($this->session->userdata("alert_loginsukses"))) { ?>
        <div class="alert alert-danger text-center">
            <strong><?php echo $this->session->userdata("alert_loginsukses"); ?></strong>
         </div>
      <?php } ?>
                  ...
                  <div class="container">
                     <div class="row justify-content-center">
                        <div class="col-md-5">
                           <br><br><br><br>
                           <div class="book_room">
                              <h1>Pilih lama menginap<p>Tanggal yang tersedia maksimal 60 hari dari hari sekarang</p></h1>
                              
                              <form id="request" class="book_now" action="<?php echo base_url('VillaPemesanan/CekKetersediaan')?>" method="post">
                                 <div class="row justify-content-center">
                                    <div class="col-md-12 ">
                                    ...
                                    <div class="col-md-12">
                                       ...
                                       <input class="online_book" placeholder="yyyy/mm/dd" type="date" name="tgl_dari">
                                    </div>
                                    <div class="col-md-12">
                                       <span>Sampai</span>
                                       <img class="date_cua" src="<?= base_url('public/template_user/images/date.png')?>">
                                       <input class="online_book" placeholder="yyyy/mm/dd" type="date" name="tgl_sampai">
                                    </div>
                                    <div class="col-md-12">
                                       <button class="book_btn">Cek Ketersediaan</button>
                                    </div>
                                 </div>
                              </form>
                           </div>
