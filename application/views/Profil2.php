   ...
   <body class="main-layout">
      ...
      <div class="contact">
         <div class="container">
            ...
            <div class="row justify-content-center">
               <div class="col-md-4">
                  <form id="request" class="main_form" action="<?php echo base_url('profil/aksi_edit_profil')?>" method="post">
                     <div class="row justify-content-center">
                        <div class="col-md-12 ">
                           <p>Nama</a></p>
                           <input class="contactus"  type="type" name="nama" value="<?php foreach ($profil->result_array() as $profil_data){
                              echo $profil_data['nama']; 
                              }?>"> 
                        </div>
                        <div class="col-md-12 ">
                           <p>Username</a></p>
                           <input class="contactus"  type="type" name="username" value="<?php foreach ($profil->result_array() as $profil_data){
                        ...
                        <div class="col-md-12 ">
                           <p>Nomer Telepon</a></p>
                           <input class="contactus"  type="type" name="no_telp" value="<?php foreach ($profil->result_array() as $profil_data){
                              echo $profil_data['nomer_telepon']; 
                              }?>"> 
                        </div>
                        
                        <?php } ?>
                        <button class="send_btn col-md-12 justify-content-center" type="submit">Edit</button>
                        </div>
