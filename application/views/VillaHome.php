                     ...
                     <nav class="navigation navbar navbar-expand-md navbar-dark ">
                        ...
                        <div class="collapse navbar-collapse" id="navbarsExample04">
                           <ul class="navbar-nav mr-auto">
                              ...
                              <li class="nav-item">
                                 <a class="nav-link" href="<?php echo base_url('VillaPemesanan')?>">Pemesanan</a>
                              </li>
                              <?php } ?>
                              <?php if ($this->session->userdata("tipe_user") == 'admin' || $this->session->userdata("tipe_user") == 'customer') { ?>
                                 <li class="nav-item">
         ...
         <div class="container">
            <div class="row">
               <div class="col-md-12">
                  <div class="titlepage">
                     <h2>Our Villa</h2>
                     <p>Pande House Villa Bali menawarkan berbagai macam jenis villa</p>
                  </div>
               </div>
            </div>
            ...
            <div class="row justify-content-center" >
               ...
               <div class="col-md-4 col-sm-6" >
                  <a href="<?php echo base_url('VillaDeskripsi/index/').$villa_data['id_villa'];?>">
                  <div id="serv_hover"  class="room">
                     <div class="room_img">
                        <figure><img src="<?= base_url('public/template_user/images/').$villa_data['sampul']; ?>"/></figure>
                     </div>
                     <div class="bed_room">
                        <tr>
                        <h3><?php echo $villa_data['nama']; ?></h3>
                        </tr>
                     </div>
                  </div></a>
               </div>
