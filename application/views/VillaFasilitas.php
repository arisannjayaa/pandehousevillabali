...
<html lang="en">
   ...
   <body class="main-layout">
      ...
      <!-- end about -->
      <!-- our_room -->
      <?php foreach ($fasilitas->result_array() as $fasilitasx);?>
      <?php if (empty($fasilitasx['fasilitas'])) { ?>
         ...
         <div class="container">
            <div class="row">
               <div class="col-md-12">
                  <div class="titlepage">
                     <h2>Fasilitas</h2>
                     <p>Berikut adalah fasilitas yang kami tawarkan</p>
                  </div>
               </div>
            </div>
         </div>
      ...
      <div class="about">
         <div class="container-fluid">
            ...
            <div class="row">
               ...
               <div class="col-md-5">
                  <div class="titlepage">
                     <br><br><br><br><h2><?php echo $fasilitas_data['fasilitas'];?></h2>
                     <p><?php echo $fasilitas_data['deskripsi'];?></p>
                     <!-- <a class="read_more" href="Javascript:void(0)"> Read More</a> -->
                  </div>
               </div>
               <div class="col-md-7">
                  <div class="about_img">
                     <figure><img src="<?= base_url('public/template_user/images/').$fasilitas_data['foto'];?>" alt="#"/></figure>
                  </div>
               </div>
               <br><br><br>
